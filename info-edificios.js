...
const infoObras = {
  ...
  'InfoObras_Roma': {
    ...
    texto: 'Roma (1972) es uno de los films más emblemáticos de Fellini. Es un «falso» documental narrado desde la ficción. Se trabaja tanto en locaciones de la ciudad como en estudio para reconstruir aquello que ya no se puede filmar. El director italiano realiza una lectura desde el medio cinematográfico (“La ciudad duerme, el hombre de la cámara viene a despertarla”, en palabras de Jean-Louis Comolli) y construye una visión de la ciudad conforme a su propia mirada. Así, se evidencia el problema de representar la ciudad: lo público y lo privado conviven de modo fragmentado. El montaje utilizado no responde a una lógica lineal (propio del cine clásico narrativo), sino que opera con fracciones que constituyen nuevas temporalidades. Fellini descompone el lenguaje y trabaja con la elipsis temporal. Al mismo tiempo, se piensa al cine como un arte plebeyo —evidenciado a través de espectáculos de varietés—, tal como era considerado en sus inicios. Por momentos, el director se pone en escena para develar cómo funciona dicho procedimiento delante de la cámara. La película fue proyectada en nuestro país en su materialidad fílmica original en la Sala Lugones, uno de los pocos espacios de exhibición en la ciudad en el que todavía esto es posible.'
  },
  ...
  'InfoExpo_PoeticasOblicuas': {
    ...
    texto: 'La exposición reunió un conjunto de obras de treinta y ocho artistas de la poesía experimental en Argentina, desde mediados de los cincuenta del siglo XX hasta la segunda década del siglo XXI, que incluía: poesía visual, matemática, performática, videos, instalaciones, entre otras. Muchas de las obras utilizaban como soporte el papel; por lo tanto, fueron exhibidas en vitrinas para su conservación. Sin embargo, originalmente estas se destinaban a una circulación por fuera del museo, para ser manipuladas por un lector. A nivel expositivo, se evidencia un guion curatorial cronológico, organizado a partir de los grupos que congregaban las producciones de la época: Movimiento Diagonal Cero (1966-1969); Paralengua (1989-1998), con producción de poemas visuales, sonoros, virtuales, videos, performances, en los que la poesía confluye con el teatro, la música y la danza; y obras de Vórtice Argentina, que produce poesía experimental desde 1996 e incorpora el arte correo y el libro de artista. Las piezas exhibidas presentaban combinaciones entre la palabra y los signos, la tipografía, su disposición y diseño en el espacio y color (o ausencia de él). Se apelaba a un carácter lúdico para hacer partícipe al espectador desde la acción de ver-leer las obras.'
  },
  ...
  'InfoExpo_ImagenesExpandidas': {
    ...
    texto: 'Pastorino experimenta con las diversas posibilidades de elaboración y captura de la fotografía. Se apoya en la investigación de los principios técnicos del medio para controlar el proceso de registro e incluso elabora sus propios aparatos. Esta exposición presentó gran parte de sus obras, que van desde fotografías expandidas hasta instalaciones. Incluía, por un lado, imágenes aéreas tomadas con barriletes y aviones. En este caso, el resultado del acto fotográfico se torna impredecible y azaroso, ya que no se previsualiza aquello que la cámara captura y, por lo tanto, es esta la que define la imagen resultante. Por otro lado, se exhibía una serie de panorámicas tomadas con una cámara diseñada y construida específicamente para este proyecto, donde el artista buscó registrar fenómenos del espacio urbano representando las imágenes en movimiento dentro de capturas fijas. Para lograrlo, construye una cámara tipo slit que mueve la película en su interior, mientras el obturador permanece abierto. De esta manera, se expone una imagen sin cortes, tan larga como la película que se utilice. Al tener conocimiento del funcionamiento de la caja negra, el artista manipula toda la producción y reproducción de la imagen, ubicando a la fotografía se ubica en el terreno del símbolo.'
  },
  ...
  'InfoExpo_JosephBeuys': {
    ...
    texto: 'La exhibición del artista alemán Beuys —organizada en conjunto con la Galerie Thomas Modern, el Instituto Plano Cultural y Fundación Proa— presentó un conjunto de más de 110 obras (dibujos, esculturas, instalaciones y videos, realizadas entre los años 1955 y 1985) donde se expuso el universo estético y revolucionario de su trabajo inscripto en las tardovanguardias que abogaban por la reconciliación entre arte y vida cotidiana. La muestra prosiguió su itinerancia por Latinoamérica. Beuys propone una crítica a la institución artística y su separación de la praxis vital, a través de una ruptura con el paradigma estético tradicional. El artista postula la no mediación entre obra y espectador, a partir de aceptar su trabajo como manifestaciones; expresiones que atraviesan el terreno de lo indiscernible, de lo indefinido, de lo híbrido y hasta de lo siniestro. El efecto de extrañamiento, distanciamiento y provocación que recupera de las vanguardias se traduce en un gesto alquímico de transformación de la materia física, psíquica y espiritual. El contacto con la obra abre un espacio para el pensamiento y la acción en el espectador, objetivo que el artista perseguía a través del lema «todo hombre es un artista» y de la insistencia en la acción y en la performance como una operación física y química.'
  },
